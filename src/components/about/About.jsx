...
import "./about.css";
import AboutImg from "../../assets/illustrationME.png";
import CV from "../../assets/CV-Damian-Coronel.pdf";
        ...
        <div className="about__container container grid">
          ...
          <div data-aos="fade-down" className="about__data">
            ...
            <p className="about__description">
              Tengo 21 años, soy desarrollador web. Autodidacta,
            ...
            <a href={CV} target="__blank" className="button button--flex">
              Ver CV
              <svg
